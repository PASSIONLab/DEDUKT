...
#define INIT_READIDS_FNAME "init_readids.txt"
#define OVERLAP_OUT_FNAME "overlaps.out"
#define ALGNMNT_OUT_FNAME "alignments.out"
...
#define TARGET_CHUNK_PER_THREAD 8192L
#endif

#ifndef MIN_CHUNK_SIZE
#define MIN_CHUNK_SIZE 4L
#endif

#ifndef MAX_CHUNK_MEMORY_PER_NODE
#define MAX_CHUNK_MEMORY_PER_NODE (1024L*1024L*1024L)
#endif
*/
